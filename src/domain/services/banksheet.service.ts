...
export class BankSheetService {
    ...
    getBankSheet<T>(URL: any, params?: HttpParams): Observable<BaseResponse<T>> {
        return this.apiService.get<BaseResponse<T>>(URL, params)
    }

    getDownloadBankSheet(url: string, params?: HttpParams): Observable<Blob> {
    ...
    postDownloadBankSheet(url: string, formData?: FormData): Observable<Blob> {
    ...
    postBankSheet<T>(URL: string, obj: any): Observable<BaseResponse<T>> {
        return this.apiService.post<BaseResponse<T>>(URL, obj);
    }

    putBankSheet<T>(URL: string, obj: any,): Observable<BaseResponse<T>> {
        return this.apiService.put<BaseResponse<T>>(URL, obj);
    }

    deleteBankSheet<T>(URL: any, params?: HttpParams): Observable<BaseResponse<T>> {
