...
@Component({
    selector: 'icon-Reject',
    template: `
        <ng-template #template>
        <svg fill="#F171B1" version="1.1" baseProfile="tiny" id="Layer_1"
            ...
            height="64px" viewBox="0 0 42.00 42.00" xml:space="preserve" stroke="#EF9153"
            stroke-width="0.00042000000000000007">
            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"
                stroke="#CCCCCC" stroke-width="2.016"></g>
...
export class IconRejectComponent {
    @Input() class: any = '';
