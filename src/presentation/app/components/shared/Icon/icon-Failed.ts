...
@Component({
    selector: 'icon-Failed',
    template: `
        <ng-template #template>
        <svg fill="#FA6060" version="1.1" baseProfile="tiny" id="Layer_1"
            ...
            height="64px" viewBox="0 0 42.00 42.00" xml:space="preserve" stroke="#94C196"
...
export class IconFailedComponent {
    @Input() class: any = '';
