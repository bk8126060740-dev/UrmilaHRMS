...
@Component({
    ...
    template: `
        ...
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
            ...
            class="">
            <g>
                <circle cx="256" cy="119.631" r="87" fill="currentColor" opacity="1"
                    data-original="#000000" class=""></circle>
                <circle cx="432" cy="151.63" r="55" fill="currentColor" opacity="1"
                    data-original="#000000" class=""></circle>
                <circle cx="80" cy="151.63" r="55" fill="currentColor" opacity="1"
                    data-original="#000000" class=""></circle>
                <path
...
export class IconClientComponent {
    @Input() class: any = '';
