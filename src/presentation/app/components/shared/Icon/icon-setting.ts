...
@Component({
    ...
    template: `
        ...
        <svg xmlns="http://www.w3.org/2000/svg"
            version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="18px" height="18px" x="0" y="0"
            ...
            <g>
                <path fill-rule="evenodd"
                    ...
                    clip-rule="evenodd" fill="currentColor" opacity="1" data-original="currentColor"></path>
            </g>
        </svg>
        </ng-template>
    `,
